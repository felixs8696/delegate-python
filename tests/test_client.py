...
from delegate import Delegate, AsyncDelegate, APIResponseValidationError
from delegate._types import Omit
from delegate._models import BaseModel, FinalRequestOptions
from delegate._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from delegate._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Delegate | AsyncDelegate) -> int:
...
class TestDelegate:
    client = Delegate(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "delegate/_legacy_response.py",
                        "delegate/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"DELEGATE_API_KEY": Omit()}):
            client2 = Delegate(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Delegate) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Delegate(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Delegate(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Delegate(
    ...
    def test_base_url_trailing_slash(self, client: Delegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Delegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Delegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Delegate(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Delegate(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Delegate(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("delegate._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Delegate) -> None:
    ...
    @mock.patch("delegate._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Delegate) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Delegate, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncDelegate:
    client = AsyncDelegate(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"DELEGATE_API_KEY": Omit()}):
            client2 = AsyncDelegate(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncDelegate) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncDelegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncDelegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncDelegate) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncDelegate(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncDelegate(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncDelegate
    ) -> None:
        respx_mock.get("/").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncDelegate, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from delegate._utils import asyncify
        from delegate._base_client import get_platform
