...
class TestStore:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_inventory(self, client: Delegate) -> None:
        store = client.store.list_inventory()
        assert_matches_type(StoreListInventoryResponse, store, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_inventory(self, client: Delegate) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list_inventory(self, client: Delegate) -> None:
...
class TestAsyncStore:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_inventory(self, async_client: AsyncDelegate) -> None:
        store = await async_client.store.list_inventory()
        assert_matches_type(StoreListInventoryResponse, store, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_inventory(self, async_client: AsyncDelegate) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list_inventory(self, async_client: AsyncDelegate) -> None:
