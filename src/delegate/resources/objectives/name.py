...
class NameResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Get an objective by its unique name.
        ...
        if not objective_name:
            raise ValueError(f"Expected a non-empty value for `objective_name` but received {objective_name!r}")
        return self._get(
            f"/objectives/name/{objective_name}",
    ...
    def delete(
        ...
        *,
        ...
        """
        Delete an objective by its unique name.
    ...
    def stream_events(
        ...
        *,
        ...
        """
        Stream events for an objective by its unique name.
        ...
        if not objective_name:
            raise ValueError(f"Expected a non-empty value for `objective_name` but received {objective_name!r}")
        return self._get(
            f"/objectives/name/{objective_name}:stream",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
