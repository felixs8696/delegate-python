...
from ...types.channel_messages import batch_create_params, batch_update_params
from ...types.create_channel_message_param import CreateChannelMessageParam
from ...types.channel_messages.batch_create_response import BatchCreateResponse
from ...types.channel_messages.batch_update_response import BatchUpdateResponse
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        channel_id: str,
        messages: Iterable[CreateChannelMessageParam],
        ...
        """
        Create multiple messages in a channel.
    ...
    def update(
        ...
        *,
        ...
        """
        Update multiple messages in a channel.

        Args:
          channel_id: The channel id

          updates: The updates to apply to messages. The key is the message id and the value is the
              update request.
