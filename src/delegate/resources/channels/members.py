...
from ...types.channels import member_list_params, member_update_params
from ...types.channel_membership import ChannelMembership
from ...types.channels.member_list_response import MemberListResponse
...
class MembersResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        Args:
          role: The user's new role in the channel (member, admin, owner)
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"limit": limit}, member_list_params.MemberListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"limit": limit}, member_list_params.MemberListParams),
            ),
            cast_to=MemberListResponse,
        )
