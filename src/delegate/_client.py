...
from .resources import spans, users, events, states, messages, objectives
...
class Delegate(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        base_url_env = os.environ.get("DELEGATE_BASE_URL")
        if is_given(base_url) and base_url is not None:
            ...
            if base_url_env and base_url is not None:
                raise ValueError(
                    "Ambiguous URL; The `DELEGATE_BASE_URL` env var and the `environment` argument are given. If you want to use the environment, you must pass base_url=None",
                )
